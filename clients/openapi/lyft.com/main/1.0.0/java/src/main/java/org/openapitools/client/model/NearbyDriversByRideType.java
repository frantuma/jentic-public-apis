...
public class NearbyDriversByRideType {
  ...
  public NearbyDriversByRideType drivers(@javax.annotation.Nullable List<NearbyDriver> drivers) {
  ...
  public void setDrivers(@javax.annotation.Nullable List<NearbyDriver> drivers) {
    this.drivers = drivers;
  }


  public NearbyDriversByRideType rideType(@javax.annotation.Nullable String rideType) {
  ...
  public void setRideType(@javax.annotation.Nullable String rideType) {
    this.rideType = rideType;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("drivers", "ride_type"));
