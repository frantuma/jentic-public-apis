...
public class RideRequest {
  ...
  public RideRequest destination(@javax.annotation.Nullable Location destination) {
  ...
  public RideRequest origin(@javax.annotation.Nullable Location origin) {
    this.origin = origin;
    return this;
  }
  ...
  public void setOrigin(@javax.annotation.Nullable Location origin) {
    this.origin = origin;
  }


  public RideRequest passenger(@javax.annotation.Nullable PassengerDetail passenger) {
  ...
  public RideRequest rideId(@javax.annotation.Nullable String rideId) {
    this.rideId = rideId;
    return this;
  }
  ...
  public RideRequest status(@javax.annotation.Nullable RideStatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("destination", "origin", "passenger", "ride_id", "status"));
