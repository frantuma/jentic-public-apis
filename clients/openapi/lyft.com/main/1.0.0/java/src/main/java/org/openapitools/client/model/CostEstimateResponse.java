...
public class CostEstimateResponse {
  ...
  public CostEstimateResponse costEstimates(@javax.annotation.Nullable List<CostEstimate> costEstimates) {
  ...
  public void setCostEstimates(@javax.annotation.Nullable List<CostEstimate> costEstimates) {
    this.costEstimates = costEstimates;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("cost_estimates"));
