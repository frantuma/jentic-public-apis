...
public class Location {
  ...
  public Location lat(@javax.annotation.Nonnull Double lat) {
    this.lat = lat;
    return this;
  }
  ...
  public Location lng(@javax.annotation.Nonnull Double lng) {
    this.lng = lng;
    return this;
  }
  ...
  public Location address(@javax.annotation.Nullable String address) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("lat", "lng", "address"));
