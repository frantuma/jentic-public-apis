...
public class RideReceipt {
  ...
  public RideReceipt charges(@javax.annotation.Nullable List<Charge> charges) {
  ...
  public RideReceipt lineItems(@javax.annotation.Nullable List<LineItem> lineItems) {
  ...
  public RideReceipt price(@javax.annotation.Nullable Cost price) {
    this.price = price;
    return this;
  }
  ...
  public RideReceipt requestedAt(@javax.annotation.Nullable OffsetDateTime requestedAt) {
  ...
  public RideReceipt rideId(@javax.annotation.Nullable String rideId) {
    this.rideId = rideId;
    return this;
  }
  ...
  public RideReceipt rideProfile(@javax.annotation.Nullable RideProfileEnum rideProfile) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("charges", "line_items", "price", "requested_at", "ride_id", "ride_profile"));
