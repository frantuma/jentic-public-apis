...
public class RideRequestError {
  ...
  public RideRequestError costToken(@javax.annotation.Nullable String costToken) {
  ...
  public RideRequestError error(@javax.annotation.Nonnull String error) {
    this.error = error;
    return this;
  }
  ...
  public RideRequestError errorDescription(@javax.annotation.Nullable String errorDescription) {
  ...
  public RideRequestError errorDetail(@javax.annotation.Nullable List<ErrorDetail> errorDetail) {
  ...
  public void setErrorDetail(@javax.annotation.Nullable List<ErrorDetail> errorDetail) {
    this.errorDetail = errorDetail;
  }


  public RideRequestError errorUri(@javax.annotation.Nullable String errorUri) {
  ...
  public RideRequestError primetimeConfirmationToken(@javax.annotation.Nullable String primetimeConfirmationToken) {
  ...
  public RideRequestError primetimeMultiplier(@javax.annotation.Nullable Float primetimeMultiplier) {
  ...
  public void setPrimetimeMultiplier(@javax.annotation.Nullable Float primetimeMultiplier) {
    this.primetimeMultiplier = primetimeMultiplier;
  }


  public RideRequestError primetimePercentage(@javax.annotation.Nullable String primetimePercentage) {
  ...
  public RideRequestError tokenDuration(@javax.annotation.Nullable String tokenDuration) {
  ...
  public void setTokenDuration(@javax.annotation.Nullable String tokenDuration) {
    this.tokenDuration = tokenDuration;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("cost_token", "error", "error_description", "error_detail", "error_uri", "primetime_confirmation_token", "primetime_multiplier", "primetime_percentage", "token_duration"));
