...
public class RideDetail {
  ...
  public RideDetail beaconColor(@javax.annotation.Nullable String beaconColor) {
  ...
  public void setBeaconColor(@javax.annotation.Nullable String beaconColor) {
    this.beaconColor = beaconColor;
  }


  public RideDetail canCancel(@javax.annotation.Nullable List<CanCancelEnum> canCancel) {
  ...
  public void setCanCancel(@javax.annotation.Nullable List<CanCancelEnum> canCancel) {
    this.canCancel = canCancel;
  }


  public RideDetail canceledBy(@javax.annotation.Nullable String canceledBy) {
  ...
  public void setCanceledBy(@javax.annotation.Nullable String canceledBy) {
    this.canceledBy = canceledBy;
  }


  public RideDetail cancellationPrice(@javax.annotation.Nullable CancellationCost cancellationPrice) {
  ...
  public void setCancellationPrice(@javax.annotation.Nullable CancellationCost cancellationPrice) {
    this.cancellationPrice = cancellationPrice;
  }


  public RideDetail destination(@javax.annotation.Nullable RideLocation destination) {
  ...
  public void setDestination(@javax.annotation.Nullable RideLocation destination) {
    this.destination = destination;
  }


  public RideDetail distanceMiles(@javax.annotation.Nullable Float distanceMiles) {
  ...
  public void setDistanceMiles(@javax.annotation.Nullable Float distanceMiles) {
    this.distanceMiles = distanceMiles;
  }


  public RideDetail driver(@javax.annotation.Nullable DriverDetail driver) {
    this.driver = driver;
    return this;
  }
  ...
  public void setDriver(@javax.annotation.Nullable DriverDetail driver) {
    this.driver = driver;
  }


  public RideDetail dropoff(@javax.annotation.Nullable PickupDropoffLocation dropoff) {
  ...
  public void setDropoff(@javax.annotation.Nullable PickupDropoffLocation dropoff) {
    this.dropoff = dropoff;
  }


  public RideDetail durationSeconds(@javax.annotation.Nullable Integer durationSeconds) {
  ...
  public RideDetail feedback(@javax.annotation.Nullable String feedback) {
  ...
  public RideDetail generatedAt(@javax.annotation.Nullable OffsetDateTime generatedAt) {
  ...
  public RideDetail lineItems(@javax.annotation.Nullable List<LineItem> lineItems) {
  ...
  public RideDetail location(@javax.annotation.Nullable CurrentRideLocation location) {
  ...
  public void setLocation(@javax.annotation.Nullable CurrentRideLocation location) {
    this.location = location;
  }


  public RideDetail origin(@javax.annotation.Nullable RideLocation origin) {
    this.origin = origin;
    return this;
  }
  ...
  public void setOrigin(@javax.annotation.Nullable RideLocation origin) {
    this.origin = origin;
  }


  public RideDetail passenger(@javax.annotation.Nullable PassengerDetail passenger) {
  ...
  public void setPassenger(@javax.annotation.Nullable PassengerDetail passenger) {
    this.passenger = passenger;
  }


  public RideDetail pickup(@javax.annotation.Nullable PickupDropoffLocation pickup) {
    this.pickup = pickup;
    return this;
  }
  ...
  public void setPickup(@javax.annotation.Nullable PickupDropoffLocation pickup) {
    this.pickup = pickup;
  }


  public RideDetail price(@javax.annotation.Nullable Cost price) {
    this.price = price;
    return this;
  }
  ...
  public void setPrice(@javax.annotation.Nullable Cost price) {
    this.price = price;
  }


  public RideDetail pricingDetailsUrl(@javax.annotation.Nullable String pricingDetailsUrl) {
  ...
  public void setPricingDetailsUrl(@javax.annotation.Nullable String pricingDetailsUrl) {
    this.pricingDetailsUrl = pricingDetailsUrl;
  }


  public RideDetail primetimePercentage(@javax.annotation.Nullable String primetimePercentage) {
  ...
  public void setPrimetimePercentage(@javax.annotation.Nullable String primetimePercentage) {
    this.primetimePercentage = primetimePercentage;
  }


  public RideDetail rating(@javax.annotation.Nullable Integer rating) {
    this.rating = rating;
    return this;
  }
  ...
  public RideDetail requestedAt(@javax.annotation.Nullable OffsetDateTime requestedAt) {
  ...
  public RideDetail rideId(@javax.annotation.Nullable String rideId) {
    this.rideId = rideId;
    return this;
  }
  ...
  public void setRideId(@javax.annotation.Nullable String rideId) {
    this.rideId = rideId;
  }


  public RideDetail rideProfile(@javax.annotation.Nullable RideProfileEnum rideProfile) {
  ...
  public void setRideProfile(@javax.annotation.Nullable RideProfileEnum rideProfile) {
    this.rideProfile = rideProfile;
  }


  public RideDetail rideType(@javax.annotation.Nullable RideTypeEnumWithOther rideType) {
  ...
  public void setRideType(@javax.annotation.Nullable RideTypeEnumWithOther rideType) {
    this.rideType = rideType;
  }


  public RideDetail routeUrl(@javax.annotation.Nullable String routeUrl) {
  ...
  public void setRouteUrl(@javax.annotation.Nullable String routeUrl) {
    this.routeUrl = routeUrl;
  }


  public RideDetail status(@javax.annotation.Nullable RideStatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public void setStatus(@javax.annotation.Nullable RideStatusEnum status) {
    this.status = status;
  }


  public RideDetail vehicle(@javax.annotation.Nullable VehicleDetail vehicle) {
  ...
  public void setVehicle(@javax.annotation.Nullable VehicleDetail vehicle) {
    this.vehicle = vehicle;
  }
