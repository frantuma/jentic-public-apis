...
public class ApiError {
  ...
  public ApiError errorDescription(@javax.annotation.Nullable String errorDescription) {
  ...
  public ApiError errorDetail(@javax.annotation.Nullable List<ErrorDetail> errorDetail) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("error", "error_description", "error_detail"));
