...
public class Ride {
  ...
  public Ride costToken(@javax.annotation.Nullable String costToken) {
  ...
  public Ride destination(@javax.annotation.Nullable Location destination) {
  ...
  public void setDestination(@javax.annotation.Nullable Location destination) {
    this.destination = destination;
  }


  public Ride origin(@javax.annotation.Nonnull Location origin) {
    this.origin = origin;
    return this;
  }
  ...
  public void setOrigin(@javax.annotation.Nonnull Location origin) {
    this.origin = origin;
  }


  public Ride primetimeConfirmationToken(@javax.annotation.Nullable String primetimeConfirmationToken) {
  ...
  public Ride rideType(@javax.annotation.Nonnull RideTypeEnum rideType) {
  ...
  public void setRideType(@javax.annotation.Nonnull RideTypeEnum rideType) {
    this.rideType = rideType;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("cost_token", "destination", "origin", "primetime_confirmation_token", "ride_type"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("origin", "ride_type"));
  }
