...
public class UserDetail {
  ...
  public UserDetail firstName(@javax.annotation.Nonnull String firstName) {
  ...
  public UserDetail imageUrl(@javax.annotation.Nonnull String imageUrl) {
  ...
  public UserDetail rating(@javax.annotation.Nonnull String rating) {
    this.rating = rating;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("first_name", "image_url", "rating"));
