...
public class Cost {
  ...
  public Cost amount(@javax.annotation.Nonnull Integer amount) {
    this.amount = amount;
    return this;
  }
  ...
  public Cost currency(@javax.annotation.Nonnull String currency) {
  ...
  public Cost description(@javax.annotation.Nonnull String description) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("amount", "currency", "description"));
