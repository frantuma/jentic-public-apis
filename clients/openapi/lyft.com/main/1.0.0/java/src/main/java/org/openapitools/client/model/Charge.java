...
public class Charge {
  ...
  public Charge amount(@javax.annotation.Nonnull Integer amount) {
    this.amount = amount;
    return this;
  }
  ...
  public Charge currency(@javax.annotation.Nonnull String currency) {
  ...
  public Charge paymentMethod(@javax.annotation.Nonnull String paymentMethod) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("amount", "currency", "payment_method"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("amount", "currency", "payment_method"));
  }
